...
DBMS_OUTPUT.NEW_LINE();
DBMS_OUTPUT.PUT_LINE('results for get_records: ' || q'[results => returnVal]');
DBMS_OUTPUT.NEW_LINE();
fema_data.get_records(disasterid => NULL, localevalues => NULL, results => returnVal);
