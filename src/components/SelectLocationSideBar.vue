        ...
        div(style="font-size:17px;")
          div.col-sm-6.col-md-4.col-lg-4(style="padding:0 20px; min-height:700px; background:url('../../static/img/bg_50_opacity.png')")
            ...
            div(style="margin-top:20px; overflow:hidden;")
              | Geographic Level
              #geographicLevelSelect.vueSelectContainer(style="margin: 0 10px;")
              ...
              div.col-lg-12(name="geographicLevels" style="background-color:#000; overflow:hidden; padding:10px;")
                div(class="input-group")
                  #localeSelect.vueSelectContainer
                    v-select(:value="localeSelected" :options="localeNames", label="localeName" class="vueSelectCustom" :on-change="setLocales" style="position:absolute; padding-left:35px; background:#fff;")
